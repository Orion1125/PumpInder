...
export function MatchNotification({ isOpen, onClose, currentUserImageUrl, matchedProfile }: MatchNotificationProps) {
  ...
  return (
    ...
    >
      <div
        className="border border-white/10 bg-black/70 rounded-2xl p-8 text-center animate-scale-up"
        onClick={(e) => e.stopPropagation()}
      >
        <h2 className="text-5xl font-black text-white mb-4">
          It&apos;s a Match!
        </h2>
        <p className="text-gray-300 text-lg mb-6">You and {matchedProfile.name} have liked each other.</p>
